...
public class ProductGet extends MyAsynckTask {
    ...
    public ProductGet(String token, CheckInternet checkInternet, MyResponseCallback callback) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            Connection.Response response = Jsoup.connect(Settings.Url + "product/get")
