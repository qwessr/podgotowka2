...
public class ProductGetId extends MyAsynckTask {
    ...
    public ProductGetId(int id, String token, CheckInternet checkInternet, MyResponseCallback callback) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            Connection.Response response = Jsoup.connect(Settings.Url + "product/" + id)
